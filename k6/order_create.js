...
export default function () {
    const url = 'http://localhost:8080/api/v1/orders'; // 서버 주소에 맞게 수정 (테스트할 주소)

    // DTO 구조에 맞춘 페이로드 설정
    const payload = JSON.stringify({
        memberId: 1,
        productId: [60, 61], // 리스트 형태
        count: [2, 1],       // 리스트 형태
